...
export const slash_data = new SlashCommandBuilder()
    ...
    .setDescriptionLocalizations({
        tr: "Twitchde yayın açtığında kanala bildirm gönderir",
        de: "Wenn er auf Twitch sendet, sendet er eine Benachrichtigung an den Kanal",
    })
    .addStringOption((option) =>
        option
            ...
            .setDescriptionLocalizations({
                tr: "Twitch kullanıcı adını gir",
                de: "Geben Sie Ihren Twitch-Benutzernamen ein",
            }))
    .addChannelOption((option) =>
        option
            .setName("channel")
            .setDescription("Channel to send notification")
            .setRequired(true)
            .setNameLocalizations({
                tr: "kanal",
            })
            .setDescriptionLocalizations({
                tr: "Bildirim göndereceğim kanal",
                de: "Kanal zum Senden der Benachrichtigung",
            })
    )
    .addStringOption((option) =>
        option
            .setName("message")
            .setDescription("Message to be sent when live is on")
            .setRequired(true)
            .setNameLocalizations({
                tr: "mesaj",
            })
            .setDescriptionLocalizations({
                tr: "Yayın açtığında gönderilecek mesaj",
                de: "Nachricht zu senden, wenn sie sich öffnet",
            }))